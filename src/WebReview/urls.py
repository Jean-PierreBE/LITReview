...
urlpatterns = [
    ...
    path('home/create_review/<int:ticket_pk>', login_required(review.views.review_create.as_view()), name='create_review'),
    path('home/abonnements/<int:pk>', login_required(review.views.follow_user_delete.as_view()), name='delete_abonnements'),
    ...
    path('home/posts/delete_ticket/<int:pk>', login_required(review.views.ticket_delete.as_view()), name='delete_ticket'),
