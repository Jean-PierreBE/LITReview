...
urlpatterns = [
    ...
    path('home/delete_review/<int:pk>', login_required(review.views.review_del), name='delete_review'),
    path('home/create_ticket', login_required(review.views.CreateTicketView.as_view()), name='create_ticket'),
    path('home/posts/delete_ticket/<int:pk>', login_required(review.views.ticket_del), name='delete_ticket'),
    path('home/posts/edit_ticket/<int:pk>', login_required(review.views.ticket_update), name='edit_ticket'),
